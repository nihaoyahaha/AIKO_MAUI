...
public class PinchToZoomContainerForCheckPointDetail : ContentView
{
    ...
    private bool NeedsFit = false;

#if WINDOWS
    private FrameworkElement? _platformView;
#endif

    public PinchToZoomContainerForCheckPointDetail()
    {
    ...
    public void FitToScreen()
    {
        ...
        double scaleX = Width / LayerWidth;
        double scaleY = Height / LayerHeight;
        double fitScale = Math.Min(scaleX, scaleY);

        MinScale = Math.Min(0.5, fitScale);
